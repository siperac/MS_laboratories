...
report_timing -nworst 10 > ./reports/high/DLX-t.rpt
report_area > ./reports/high/DLX-a.rpt
report_power > ./reports/high/DLX-p.rpt

# write -hierarchy -format ddc -output ./post_syn/high/DLX-A-topt.ddc
# write -hierarchy -format vhdl -output ./post_syn/high/DLX-A-topt.vhdl
write -hierarchy -format verilog -output ./post_syn/high/DLX-A-topt.v

...
compile_ultra
# # save report
 report_timing -nworst 10 > ./reports/ultra/DLX-t.rpt
 report_area > ./reports/ultra/DLX-a.rpt
 report_power > ./reports/ultra/DLX-p.rpt
# saving files

# write -hierarchy -format ddc -output ./post_syn/ultra/DLX-A-topt.ddc
# write -hierarchy -format vhdl -output ./post_syn/ultra/DLX-A-topt.vhdl
write -hierarchy -format verilog -output ./post_syn/ultra/DLX-A-topt.v
